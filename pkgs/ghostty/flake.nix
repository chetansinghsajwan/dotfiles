{
  ...
  # No nix-wrapper-modules here: home-manager's own programs.ghostty
  # module already handles config-file generation, shell integration, and
  # bat/vim syntax install directly - wrapping the binary would add
